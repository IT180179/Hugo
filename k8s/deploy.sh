...
docker image tag cagitz-hugo-page ghcr.io/it180179/cagitz-hugo-page:latest
docker push ghcr.io/it180179/cagitz-hugo-page:latest
docker image tag hugo-backend-cagitz ghcr.io/it180179/hugo-backend-cagitz:latest
docker push ghcr.io/it180179/hugo-backend-cagitz:latest
